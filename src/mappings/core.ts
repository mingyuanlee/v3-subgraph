...
import { findEthPerToken, 
  getEthPriceInUSD,
  getTrackedAmountUSD, sqrtPriceX96ToTokenPrices } from '../utils/pricing'
import {
  updatePoolDayData,
  updatePoolHourData,
  updateTickDayData,
...
export function handleSwap(event: SwapEvent): void {
  ...
  let amountTotalETHTracked = safeDiv(amountTotalUSDTracked, BigDecimal.fromString('2'))
